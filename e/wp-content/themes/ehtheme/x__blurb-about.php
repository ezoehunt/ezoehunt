...
<p>Recovering academic (Ph.D. English Lit) who landed, by happy accident, in the technology world &#8212; first as a front‑end developer, later as a UX designer.</p>

<p><b>Currently looking for new opportunities to create meaningful experiences that improve people's lives. <a class="home" title="Get in touch!" href="mailto:<?php echo antispambot("eh@ezoehunt.com"); ?>">Please get in touch!</a></b></p>
...
<p>In 2012 I had the honor of being selected as a <a class="home" title="Go to Code for America" href="http://www.codeforamerica.org/about" target="_blank">Code for America Fellow</a>. Since then I've become a bit of a gov&#8209;geek, and I continue to design (and make) civic projects in my spare time.</p>

<p class="last see-all col-xs-12 col-md-4">
  <a class="home" title="About Me" href="<?php echo esc_url( home_url('/about') ); ?>">Contact info and more about me <span class="link-raquo">&raquo;</span></a>
</p>
