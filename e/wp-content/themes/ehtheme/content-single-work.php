...
<?php while ( have_posts() ) : the_post(); ?>
    ...
    <ul id="mypills" class="nav nav-pills" role="tablist">
      ...
      <li class="nav-item">
        <a title="See Design" class="nav-link active pill-nav" data-toggle="tab" href="#design" role="tab">See Design</a>
      </li>

      <li class="nav-item">
        <a title="See Process" class="nav-link pill-nav" data-toggle="tab" href="#process" role="tab">See Process</a>
      </li>
